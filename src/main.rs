use rustgraphs::simplepathgraph::{SimplePathGraph, SimplePathGraphEdgeIterator};
use rustgraphs::staticgraph::{StaticGraph, StaticGraphEdgeIter};
...
fn main() {
    ...
    println!("{}", g);
    // println!("{:?}", g.vertices());
    let ei = SimplePathGraphEdgeIterator::new(&g);
    ...
    println!("{}", g2);
    let ei2 = StaticGraphEdgeIter::new(&g2);
    println!("----------------");
    println!("{:?}", ei2);
